      ...
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center space-y-6 p-6">
        ...
        <div className="text-center space-y-2">
          <p className="text-slate-400 font-medium">
            {authTimeout ? "Connection taking longer than expected..." : "Initializing voiceforge-tts..."}
          </p>
          {authTimeout && (
            <p className="text-xs text-slate-500 max-w-xs mx-auto">
              This can happen if Firebase is still provisioning or if there's a network issue.
            </p>
          )}
        </div>
  ...
  return (
    <ErrorBoundary>
      ...
      >
              ...
              <div className="relative group">
                ...
                >
                  {BASE_VOICES.map(voice => (
                    <option key={voice.id} value={voice.id} className="bg-slate-900">{voice.name} ({voice.gender}) — {voice.description}</option>
                  ))}
                </select>
        ...
        <section className="pt-16 border-t border-slate-900 space-y-8">
            ...
            {BASE_VOICES.map((voice, idx) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className={cn(
                        "text-[8px] px-1.5 py-0.5 rounded-full font-black uppercase tracking-wider",
                ...
                <button 
                  ...
                  className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-blue-400 hover:bg-blue-500 hover:text-white transition-all duration-300 shadow-lg shadow-blue-900/20"
                >
              ...
              >
                ...
                <div className="p-8 overflow-y-auto grid grid-cols-1 md:grid-cols-3 gap-6 bg-slate-900/50">
                  ...
                  <div className="relative p-6 rounded-2xl border-2 border-amber-500/30 bg-amber-950/20 backdrop-blur-md flex flex-col space-y-6 hover:border-amber-500/50 transition-all group">
                    ...
                    <div className="space-y-1">
                      <h3 className="text-lg font-bold text-white">Founder Monthly</h3>
                  ...
                  <div className="relative p-6 rounded-2xl border-2 border-blue-500/30 bg-blue-950/20 backdrop-blur-md flex flex-col space-y-6 hover:border-blue-500/50 transition-all group">
                    ...
                    <div className="space-y-1">
                      <h3 className="text-lg font-bold text-white">Founder Yearly</h3>
                      <p className="text-xs text-slate-500">First 500 users only</p>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[10px] text-blue-400 font-bold">Save £13 per year</p>
                    </div>
